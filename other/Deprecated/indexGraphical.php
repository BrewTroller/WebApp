      ...
      <div class="row">
            <div class="col-sm-4">
            	<div class="panel panel-default vesselPanel">
                    ...
                    <div class="panel-body">
                    	<div id="hltTempSet"><span id="div_hltTemperature">
                    		<canvas id="hltGauge" width="200" height="200"></canvas>
                    	</span> <span id="div_hltSetpoint"></span></div>
                ...
                <div class="panel panel-default vesselPanel">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="mashTempSet">
                        	...
                        	<span id="div_mashSetpoint"></span></div>
							...
							<div class="row">
								<div class="col-sm-6">
									<div id="kettleTempSet">
										...
										<span id="div_kettleSetpoint"></span>
									</div>
